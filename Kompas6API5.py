...
class ksCurve3D(DispatchBaseClass):
	...
	def IsEllipseArc(self):
		'Является ли кривая дугой эллипса.'
		return self._oleobj_.InvokeTypes(25, LCID, 1, (11, 0), (),)

	def IsLineSeg(self):
		'Является ли кривая отрезком.'
...
#	def OnBeginDeleteProperty(self, objRef=defaultNamedNotOptArg, propID=defaultNamedNotOptArg):
#		'Начало удаления значения свойства.'
#	def OnDeleteProperty(self, objRef=defaultNamedNotOptArg, propID=defaultNamedNotOptArg):
...
class ksDocument3D(DispatchBaseClass):
	...
	_prop_map_get_ = {
		...
		"matesMultiCreatedMode": (90, 2, (11, 0), (), "matesMultiCreatedMode", None),
	...
	_prop_map_put_ = {
		...
		"matesMultiCreatedMode" : ((90, LCID, 4, 0),()),
...
#	def OnBeginDeleteMaterial(self):
...
#	def OnDeleteProperty(self, obj=defaultNamedNotOptArg, propID=defaultNamedNotOptArg):
#		'Завершение удаления свойства.'
...
#		'Начало выбора свойства.'
#	def OnBeginDeleteProperty(self, obj=defaultNamedNotOptArg, propID=defaultNamedNotOptArg):
#		'Начало удаления значения свойства.'
...
#	def OnActivateToolbarSet(self, OldToolbarSetId=defaultNamedNotOptArg, NewToolbarSetId=defaultNamedNotOptArg):
#		'Активизация набора команд.'
...
class ksEdgeDefinition(DispatchBaseClass):
	...
	def IsEllipseArc(self):
		'Является ли ребро дугой эллипса.'
		return self._oleobj_.InvokeTypes(17, LCID, 1, (11, 0), (),)

	def IsLineSeg(self):
		'Является ли ребро отрезком.'
		return self._oleobj_.InvokeTypes(19, LCID, 1, (11, 0), (),)
...
class ksSpecification(DispatchBaseClass):
	...
	def ksGetSpcObjectSummaryCountText(self, spcObj=defaultNamedNotOptArg, ispoln=defaultNamedNotOptArg, block=defaultNamedNotOptArg):
		...
		ret = self._oleobj_.InvokeTypes(51, LCID, 1, (9, 0), ((3, 0), (3, 0), (3, 0)),spcObj
			, ispoln, block)
		if ret is not None:
			ret = Dispatch(ret, 'ksGetSpcObjectSummaryCountText', None)
		return ret
