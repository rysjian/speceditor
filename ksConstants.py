...
class constants:
	...
	ksControlParamGrid            =46         # from enum ControlTypeEnum
	...
	ksControlTree                 =45         # from enum ControlTypeEnum
	...
	ksControlUserWindow           =47         # from enum ControlTypeEnum
	...
	ksDrArcSlot                   =88         # from enum DrawingObjectTypeEnum
	...
	ksDrCsPoint                   =89         # from enum DrawingObjectTypeEnum
	...
	ksDrStraightSlot              =87         # from enum DrawingObjectTypeEnum
	...
	ksObjectArcSlot               =13179      # from enum KompasAPIObjectTypeEnum
	ksObjectArcSlots              =13178      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectBodySurfaceRemover    =11384      # from enum KompasAPIObjectTypeEnum
	ksObjectBodySurfaceRemovers   =11383      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectChoiceMaterialDialogParam=10135      # from enum KompasAPIObjectTypeEnum
	ksObjectChoiceModelDialogParam=10134      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectCommonNameObject      =10132      # from enum KompasAPIObjectTypeEnum
	ksObjectComponentPositioner   =11363      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectConicCurve3D          =11361      # from enum KompasAPIObjectTypeEnum
	ksObjectConicCurves           =13159      # from enum KompasAPIObjectTypeEnum
	ksObjectConicCurves3D         =11362      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectConicSurface          =11364      # from enum KompasAPIObjectTypeEnum
	ksObjectConicSurfaces         =11365      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectConvertToSheetMetal   =11366      # from enum KompasAPIObjectTypeEnum
	ksObjectConverter             =10098      # from enum KompasAPIObjectTypeEnum
	ksObjectConvertsToSheetMetals =11367      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectDraftFromEdges        =11377      # from enum KompasAPIObjectTypeEnum
	ksObjectDraftsFromEdges       =11378      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectExtensionCurve        =11369      # from enum KompasAPIObjectTypeEnum
	ksObjectExtensionCurves       =11368      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectMeasurement3D         =11380      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectModelTable            =11359      # from enum KompasAPIObjectTypeEnum
	ksObjectModelTables           =11360      # from enum KompasAPIObjectTypeEnum
	ksObjectModelText             =11357      # from enum KompasAPIObjectTypeEnum
	ksObjectModelTexts            =11358      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectMultiSpline3D         =11381      # from enum KompasAPIObjectTypeEnum
	ksObjectMultiSplines3D        =11382      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectPlane3DUnhistoried    =11376      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectPoint3DParamBetweenPoints=11379      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectPropertyParamGrid     =10133      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectPropertyTree          =10137      # from enum KompasAPIObjectTypeEnum
	ksObjectPropertyTreeNode      =10136      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectPropertyUserWindow    =10015      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectRuledSurfaceParametersByCurveAndDir=11373      # from enum KompasAPIObjectTypeEnum
	ksObjectRuledSurfaceParametersByCurveAndFace=11372      # from enum KompasAPIObjectTypeEnum
	ksObjectRuledSurfaceParametersByFaces=11370      # from enum KompasAPIObjectTypeEnum
	ksObjectRuledSurfaceTangentParametersByCurveAndFace=11371      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectStraightSlot          =13177      # from enum KompasAPIObjectTypeEnum
	ksObjectStraightSlots         =13176      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectUserComponentOperation=13175      # from enum KompasAPIObjectTypeEnum
	...
	ksObjectViewProjection7       =11374      # from enum KompasAPIObjectTypeEnum
	ksObjectViewProjectionManager =11375      # from enum KompasAPIObjectTypeEnum
	...
	prAddDummyPartFromFile        =20234      # from enum ProcessTypeEnum
	...
	prArcSlot                     =10226      # from enum ProcessTypeEnum
	...
	prBlockByPoints               =20253      # from enum ProcessTypeEnum
	prBlockBySizes                =20252      # from enum ProcessTypeEnum
	...
	prBodySurfaceRemover          =20237      # from enum ProcessTypeEnum
	...
	prChangeRefInstances          =20242      # from enum ProcessTypeEnum
	prChangeRefObjects            =20243      # from enum ProcessTypeEnum
	...
	prConicCurve3DTangentsAndHeight=20232      # from enum ProcessTypeEnum
	prConicCurve3DTangentsAndPointOnCurve=20233      # from enum ProcessTypeEnum
	prConicCurve3DVertexAndHeight =20230      # from enum ProcessTypeEnum
	prConicCurve3DVertexAndPointOnCurve=20231      # from enum ProcessTypeEnum
	...
	prCrossSections               =20249      # from enum ProcessTypeEnum
	...
	prCylinder                    =20251      # from enum ProcessTypeEnum
	...
	prInsertionView               =10224      # from enum ProcessTypeEnum
	prIntersectPoint              =10002      # from enum ProcessTypeEnum
	prIntersectionsObject         =10223      # from enum ProcessTypeEnum
	...
	prMeasureDistanceBetweenObjects=20244      # from enum ProcessTypeEnum
	...
	prMechDeviation               =20245      # from enum ProcessTypeEnum
	...
	prModelsFamily                =20238      # from enum ProcessTypeEnum
	...
	prNormalTo                    =20239      # from enum ProcessTypeEnum
	...
	prOrientationNormalToAndAling =20240      # from enum ProcessTypeEnum
	...
	prPoint3DBetweenPoints        =20236      # from enum ProcessTypeEnum
	...
	prReplaceFaces                =20247      # from enum ProcessTypeEnum
	...
	prRuledSurfaceByCurveAndFace  =20254      # from enum ProcessTypeEnum
	prRuledSurfaceByCurveAndfDirection=20256      # from enum ProcessTypeEnum
	prRuledSurfaceByFaceTangCurve =20255      # from enum ProcessTypeEnum
	...
	prSelectWithPolyline          =10222      # from enum ProcessTypeEnum
	prSelectWithRect              =10165      # from enum ProcessTypeEnum
	prSelectionBandRegular        =20259      # from enum ProcessTypeEnum
	prSelectionBandSecant         =20260      # from enum ProcessTypeEnum
	...
	prSphere                      =20250      # from enum ProcessTypeEnum
	...
	prStraightSlot                =10225      # from enum ProcessTypeEnum
	...
	prTable3D                     =20257      # from enum ProcessTypeEnum
	...
	ksAPI                         =4          # from enum ksAPITypeEnum
	...
	ksConcave                     =-1         # from enum ksAngleTypeEnum
	ksConvex                      =1          # from enum ksAngleTypeEnum
	ksError                       =-2         # from enum ksAngleTypeEnum
	ksNeutral                     =0          # from enum ksAngleTypeEnum
	...
	ksArcSlotByCentre             =1          # from enum ksArcSlotBuildingType
	ksSlotByPoints                =2          # from enum ksArcSlotBuildingType
	ksArcSlotArcCentre1           =1          # from enum ksArcSlotPointEnum
	ksArcSlotArcCentre2           =3          # from enum ksArcSlotPointEnum
	ksArcSlotCentre               =4          # from enum ksArcSlotPointEnum
	ksArcSlotMiddle               =2          # from enum ksArcSlotPointEnum
	...
	ksChangeOrderAfterObject      =4          # from enum ksChangeOrderType
	ksChangeOrderAfterObjectByGroupOrder=8          # from enum ksChangeOrderType
	ksChangeOrderBeforeObject     =3          # from enum ksChangeOrderType
	ksChangeOrderBeforeObjectByGroupOrder=7          # from enum ksChangeOrderType
	ksChangeOrderBottom           =2          # from enum ksChangeOrderType
	ksChangeOrderDownLevel        =6          # from enum ksChangeOrderType
	ksChangeOrderTop              =1          # from enum ksChangeOrderType
	ksChangeOrderUpLevel          =5          # from enum ksChangeOrderType
	ksCheckBoxDefault             =0          # from enum ksCheckBoxVisualStyleEnum
	ksCheckBoxOptional            =2          # from enum ksCheckBoxVisualStyleEnum
	...
	ksChoiceFromLibraryCancel     =0          # from enum ksChoiceFromLibraryResultEnum
	ksChoiceFromLibraryDocument   =3          # from enum ksChoiceFromLibraryResultEnum
	ksChoiceFromLibraryFolder     =2          # from enum ksChoiceFromLibraryResultEnum
	ksChoiceFromLibraryRoot       =1          # from enum ksChoiceFromLibraryResultEnum
	...
	ksChMUser1                    =201        # from enum ksChooseManagerTypeEnum
	ksChMUser10                   =210        # from enum ksChooseManagerTypeEnum
	ksChMUser2                    =202        # from enum ksChooseManagerTypeEnum
	ksChMUser3                    =203        # from enum ksChooseManagerTypeEnum
	ksChMUser4                    =204        # from enum ksChooseManagerTypeEnum
	ksChMUser5                    =205        # from enum ksChooseManagerTypeEnum
	ksChMUser6                    =206        # from enum ksChooseManagerTypeEnum
	ksChMUser7                    =207        # from enum ksChooseManagerTypeEnum
	ksChMUser8                    =208        # from enum ksChooseManagerTypeEnum
	ksChMUser9                    =209        # from enum ksChooseManagerTypeEnum
	...
	ksStateUnderConstrained       =2          # from enum ksConstraintsStateEnum
	ksStateUnknown                =0          # from enum ksConstraintsStateEnum
	ksStateUnresolvedRedundancy   =3          # from enum ksConstraintsStateEnum
	ksStateWellConstrained        =1          # from enum ksConstraintsStateEnum
	...
	ksCommonNameAllObjects        =4          # from enum ksCreateCommonNameState
	ksCommonNameCreationAvailable =0          # from enum ksCreateCommonNameState
	ksCommonNameDocIsReadOnly     =1          # from enum ksCreateCommonNameState
	ksCommonNameEnableSortSpcObj  =6          # from enum ksCreateCommonNameState
	ksCommonNameExcludedObjects   =5          # from enum ksCreateCommonNameState
	ksCommonNameExistCommonName   =8          # from enum ksCreateCommonNameState
	ksCommonNameHideObjects       =3          # from enum ksCreateCommonNameState
	ksCommonNameInvalidSection    =7          # from enum ksCreateCommonNameState
	ksCommonNameRequireNameColumnStandardInfo=9          # from enum ksCreateCommonNameState
	ksCommonNameRequiredConvert   =2          # from enum ksCreateCommonNameState
	ksCommonNameRequiredSPDoc     =10         # from enum ksCreateCommonNameState
	...
	ksCSDotted                    =26         # from enum ksCurveStyleEnum
	...
	ksCurvesIntectSimple          =0          # from enum ksCurvesIntersectFormEnum
	ksCurvesIntectTangent         =1          # from enum ksCurvesIntersectFormEnum
	ksCurvesIntersectSimple       =0          # from enum ksCurvesIntersectFormEnum
	ksCurvesIntersectTangent      =1          # from enum ksCurvesIntersectFormEnum
	ksDecimalComma                =0          # from enum ksDecimalDelimiterTypeEnum
	ksDecimalPoint                =1          # from enum ksDecimalDelimiterTypeEnum
	ksDOLCompositeObjects         =7          # from enum ksDecomposeObjectLevelEnum
	ksDOLProjectionCurves         =6          # from enum ksDecomposeObjectLevelEnum
	ksDOLSegmentsArcsPoints       =4          # from enum ksDecomposeObjectLevelEnum
	ksDOLSegmentsArcsTexts        =2          # from enum ksDecomposeObjectLevelEnum
	ksDOLSegmentsArcsTextsArrowsBases=5          # from enum ksDecomposeObjectLevelEnum
	ksDOLSegmentsArcsTextsPoints  =0          # from enum ksDecomposeObjectLevelEnum
	ksDOLSegmentsTextsPoints      =1          # from enum ksDecomposeObjectLevelEnum
	...
	ksDimensionExtensionLinePoint =4          # from enum ksDimensionPointEnum
	...
	d2BeginDeleteProperty         =9          # from enum ksDocument2DNotifyEnum
	...
	d2DeleteProperty              =10         # from enum ksDocument2DNotifyEnum
	...
	d3BeginDeleteMaterial         =18         # from enum ksDocument3DNotifyEnum
	d3BeginDeleteProperty         =20         # from enum ksDocument3DNotifyEnum
	...
	d3DeleteMaterial              =19         # from enum ksDocument3DNotifyEnum
	d3DeleteProperty              =21         # from enum ksDocument3DNotifyEnum
	...
	kdActivateToolbarSet          =15         # from enum ksDocumentFileNotifyEnum
	...
	ksLocalCSAllParam             =-12        # from enum ksDrawingObjectParamTypeEnum
	ksSheetAllParam               =-2         # from enum ksDrawingObjectParamTypeEnum
	ksViewAllParam                =-7         # from enum ksDrawingObjectParamTypeEnum
	ksDropAfter                   =0          # from enum ksDropPermissionEnum
	ksDropCopyInto                =2          # from enum ksDropPermissionEnum
	ksDropForbidden               =3          # from enum ksDropPermissionEnum
	ksDropInto                    =1          # from enum ksDropPermissionEnum
	...
	ksEFTBendTable                =35         # from enum ksExternalFilesTypesEnum
	...
	ksEFTDummy                    =34         # from enum ksExternalFilesTypesEnum
	...
	ksEFTImportingInstanceSource  =33         # from enum ksExternalFilesTypesEnum
	...
	ksEFTProductPartSource        =37         # from enum ksExternalFilesTypesEnum
	...
	ksEFTStandartProducts         =36         # from enum ksExternalFilesTypesEnum
	...
	ksEFTTuningStyleSectionsBlock =38         # from enum ksExternalFilesTypesEnum
	ksEFTUnknown                  =-1         # from enum ksExternalFilesTypesEnum
	ksFileNameMakeByDessignation  =1          # from enum ksFileNameMakeModeEnum
	ksFileNameMakeByDessignationAndName=3          # from enum ksFileNameMakeModeEnum
	ksFileNameMakeByName          =2          # from enum ksFileNameMakeModeEnum
	ksFileNameMakeByNameAndDessignation=4          # from enum ksFileNameMakeModeEnum
	ksFileNameMakeByType          =0          # from enum ksFileNameMakeModeEnum
	...
	ksFindTimmedCurve             =8          # from enum ksFindObjectsTypeEnum
	...
	ksConverterFrom3DXML          =-106       # from enum ksKOMPASConverterEnum
	...
	ksConverterToJT               =8          # from enum ksKOMPASConverterEnum
	...
	ksCM3DReplaceComponentsOnOff  =40372      # from enum ksKompasCommandEnum
	...
	ksCMDynamicCrossSection       =62160      # from enum ksKompasCommandEnum
	...
	ksCMHideInCompTables          =62369      # from enum ksKompasCommandEnum
	ksCMHideInCompTexts           =62361      # from enum ksKompasCommandEnum
	...
	ksCMHideTables                =62368      # from enum ksKompasCommandEnum
	ksCMHideTexts                 =62360      # from enum ksKompasCommandEnum
	...
	ksCMParametryzeEnable         =35714      # from enum ksKompasCommandEnum
	...
	ksRestoreStylesInAssociationView=37002      # from enum ksKompasCommandEnum
	...
	ksArc                         =204        # from enum ksMathCurve2DTypeEnum
	ksBezier                      =208        # from enum ksMathCurve2DTypeEnum
	ksCharacterCurve              =216        # from enum ksMathCurve2DTypeEnum
	ksConeBendedCurve             =220        # from enum ksMathCurve2DTypeEnum
	ksConeUnbendedCurve           =221        # from enum ksMathCurve2DTypeEnum
	ksContour                     =301        # from enum ksMathCurve2DTypeEnum
	ksContourWithBreaks           =302        # from enum ksMathCurve2DTypeEnum
	ksCosinusoid                  =205        # from enum ksMathCurve2DTypeEnum
	ksCubicSpline                 =211        # from enum ksMathCurve2DTypeEnum
	ksHermit                      =209        # from enum ksMathCurve2DTypeEnum
	ksLine                        =202        # from enum ksMathCurve2DTypeEnum
	ksLineSegment                 =203        # from enum ksMathCurve2DTypeEnum
	ksNurbs                       =210        # from enum ksMathCurve2DTypeEnum
	ksOffsetCurve                 =213        # from enum ksMathCurve2DTypeEnum
	ksPointCurve                  =215        # from enum ksMathCurve2DTypeEnum
	ksPolyCurve                   =206        # from enum ksMathCurve2DTypeEnum
	ksPolyLine                    =207        # from enum ksMathCurve2DTypeEnum
	ksProjCurve                   =217        # from enum ksMathCurve2DTypeEnum
	ksReparamCurve                =214        # from enum ksMathCurve2DTypeEnum
	ksSweptImageCurve             =218        # from enum ksMathCurve2DTypeEnum
	ksTransformedCurve            =219        # from enum ksMathCurve2DTypeEnum
	ksTrimmedCurve                =212        # from enum ksMathCurve2DTypeEnum
	ksUndefinetCurveType          =0          # from enum ksMathCurve2DTypeEnum
	...
	ntPropertyTreeNotify          =25         # from enum ksNotifyType
	...
	ksObjectStateFullDefined      =1          # from enum ksObjectConstraintsStateEnum
	ksObjectStateInformative      =3          # from enum ksObjectConstraintsStateEnum
	ksObjectStateOverDefined      =2          # from enum ksObjectConstraintsStateEnum
	ksObjectStateUnknown          =0          # from enum ksObjectConstraintsStateEnum
	ksObjectWrongProjection       =4          # from enum ksObjectConstraintsStateEnum
	...
	ksPLMCompositionConflict      =5          # from enum ksPLMCompositionEnum
	ksPLMCompositionNotRegistered =1          # from enum ksPLMCompositionEnum
	ksPLMCompositionObjectNotSync =2          # from enum ksPLMCompositionEnum
	ksPLMCompositionObjectSync    =3          # from enum ksPLMCompositionEnum
	ksPLMCompositionObjectsNotSync=4          # from enum ksPLMCompositionEnum
	ksPLMCompositionUndefined     =0          # from enum ksPLMCompositionEnum
	ksPLMChangeChanged            =1002       # from enum ksPLMObjectNotifyEnum
	ksPLMCompositionChanged       =1004       # from enum ksPLMObjectNotifyEnum
	...
	ksPOTAppObject                =512        # from enum ksProductObjectTypeEnum
	ksPOTBillet                   =128        # from enum ksProductObjectTypeEnum
	...
	ksPOTGroupObject              =256        # from enum ksProductObjectTypeEnum
	...
	ksTreeCollapseNode            =3          # from enum ksPropertyTreeNotifyEnum
	ksTreeExpandNode              =4          # from enum ksPropertyTreeNotifyEnum
	ksTreeNodeBeginTextEdit       =6          # from enum ksPropertyTreeNotifyEnum
	ksTreeNodeDblClick            =5          # from enum ksPropertyTreeNotifyEnum
	ksTreeNodeDragDroped          =10         # from enum ksPropertyTreeNotifyEnum
	ksTreeNodeDragOver            =9          # from enum ksPropertyTreeNotifyEnum
	ksTreeNodeDragStarted         =8          # from enum ksPropertyTreeNotifyEnum
	ksTreeNodeEndTextEdit         =7          # from enum ksPropertyTreeNotifyEnum
	ksTreeSelectNodes             =1          # from enum ksPropertyTreeNotifyEnum
	ksTreeUnselectNodes           =2          # from enum ksPropertyTreeNotifyEnum
	...
	ksSDV_Kompas_21               =27         # from enum ksSaveDocumentVersionEnum
	ksSDV_Kompas_22               =28         # from enum ksSaveDocumentVersionEnum
	...
	ksSectionAlignmentByLen       =1          # from enum ksSectionAlignmentEnum
	ksSectionAlignmentByParam     =0          # from enum ksSectionAlignmentEnum
	...
	ksSpecificationBilletObject   =7          # from enum ksSpecificationObjectTypeEnum
	...
	ksSpecificationCommonName     =8          # from enum ksSpecificationObjectTypeEnum
	...
	ksStraightSlotArcCenters      =1          # from enum ksStraightSlotBuildingType
	ksStraightSlotCentreArcCentre =3          # from enum ksStraightSlotBuildingType
	ksStraightSlotCentreGabarit   =4          # from enum ksStraightSlotBuildingType
	ksStraightSlotGabarit         =2          # from enum ksStraightSlotBuildingType
	ksStraightSlotArcCentre1      =1          # from enum ksStraightSlotPointEnum
	ksStraightSlotArcCentre2      =2          # from enum ksStraightSlotPointEnum
	ksStraightSlotCentre          =5          # from enum ksStraightSlotPointEnum
	ksStraightSlotPoint1          =3          # from enum ksStraightSlotPointEnum
	ksStraightSlotPoint2          =4          # from enum ksStraightSlotPointEnum
	...
	ksSurfaceSalientNo            =-1         # from enum ksSurfaceSalientTypeEnum
	ksSurfaceSalientUnknown       =0          # from enum ksSurfaceSalientTypeEnum
	ksSurfaceSalientYes           =1          # from enum ksSurfaceSalientTypeEnum
	...
	ksApplicationDirectories      =20         # from enum ksSystemPathTypeEnum
	ksApplications                =1          # from enum ksSystemPathTypeEnum
	ksBinaryFiles                 =5          # from enum ksSystemPathTypeEnum
	ksConfigurations              =3          # from enum ksSystemPathTypeEnum
	ksCurrentApplications         =16         # from enum ksSystemPathTypeEnum
	ksCurrentDocumentLibraries    =23         # from enum ksSystemPathTypeEnum
	ksCurrentProfiles             =18         # from enum ksSystemPathTypeEnum
	ksCurrentSheetmetalTables     =19         # from enum ksSystemPathTypeEnum
	ksCurrentSystemFiles          =17         # from enum ksSystemPathTypeEnum
	ksCurrentUnils                =26         # from enum ksSystemPathTypeEnum
	ksCurrentWorkFiles            =15         # from enum ksSystemPathTypeEnum
	ksDesktopFiles                =7          # from enum ksSystemPathTypeEnum
	ksDocumentLibraries           =21         # from enum ksSystemPathTypeEnum
	ksDocumentLibrariesDirectories=22         # from enum ksSystemPathTypeEnum
	ksIniFile                     =4          # from enum ksSystemPathTypeEnum
	ksMultilineTemplates          =13         # from enum ksSystemPathTypeEnum
	ksPartLib                     =12         # from enum ksSystemPathTypeEnum
	ksPrintDeviceConfigurations   =14         # from enum ksSystemPathTypeEnum
	ksProfiles                    =9          # from enum ksSystemPathTypeEnum
	ksProgramData                 =27         # from enum ksSystemPathTypeEnum
	ksProjectFiles                =6          # from enum ksSystemPathTypeEnum
	ksSheetmetalTables            =11         # from enum ksSystemPathTypeEnum
	ksSystemFiles                 =0          # from enum ksSystemPathTypeEnum
	ksTemplates                   =8          # from enum ksSystemPathTypeEnum
	ksTemporaryFiles              =2          # from enum ksSystemPathTypeEnum
	ksUnils                       =24         # from enum ksSystemPathTypeEnum
	ksUnilsDirectories            =25         # from enum ksSystemPathTypeEnum
	ksWorkFiles                   =10         # from enum ksSystemPathTypeEnum
	...
	ksTextConvertDefault          =0          # from enum ksTextConvertEnum
	ksTextConvertDestroyHyperTextRefs=3          # from enum ksTextConvertEnum
	ksTextConvertPlainText        =4          # from enum ksTextConvertEnum
	...
	ksVariableAngle               =4          # from enum ksVariableTypeEnum
	ksVariableBool                =1          # from enum ksVariableTypeEnum
	ksVariableDouble              =3          # from enum ksVariableTypeEnum
	ksVariableFunction            =6          # from enum ksVariableTypeEnum
	ksVariableInt                 =2          # from enum ksVariableTypeEnum
	ksVariableInterval            =5          # from enum ksVariableTypeEnum
	ksVariableUnknown             =0          # from enum ksVariableTypeEnum
